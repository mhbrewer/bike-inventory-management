...
namespace BikeInventoryManagement.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(BikeInventoryManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Employee != null ? 
                          ...
                          Problem("Entity set 'BikeInventoryManagementContext.Employee'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BikeInventoryManagementContext.Employee'  is null.");
            }
            var employee = await _context.Employee.FindAsync(id);
            if (employee != null)
            {
